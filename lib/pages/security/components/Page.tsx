...
import LinkMail from "gamejitsu/components/LinkMail"
import {
  Container,
  MainTitle,
  SecondaryTitle,
    ...
    <Box px={[4]} pt={[4]}>
      ...
      <Box>
        ...
        <ParagraphText>
          ...
          and disclosure based on the severity of the issue. We believe this method provides the
          most secure environment for users and coaches and the Internet at large. We will respond
          as soon as we can to fix verifiable security issues. When notified of legitimate issues,
          we will acknowledge your report, begin investigating the issue and will work to correct
          any vulnerabilities quickly.
        </ParagraphText>
