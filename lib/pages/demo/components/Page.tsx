...
const DemoPage: AuthenticatedComponent = () => {
  ...
  const reviewInitial: Review = {
    ...
    comments: [
      ...
      Your teammate in the laning phase is Windranger. While Windranger is pretty aggressive as a position 3, she doesn't have any exceptional combos with a Pudge.`, timestamp: 77
      },
      {
