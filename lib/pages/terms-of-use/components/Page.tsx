        ...
        <Box width="900px" mx="auto" my={4} style={{ position: "relative" }}>
          ...
          <Box width="900px">
            <ParagraphText>
              ...
              These terms and conditions apply between you, the User of this Website (including any sub-domains, unless expressly excluded by their own terms and conditions), and  Gamejitsu LTD,  the owner and operator of this Website. Please read these terms and conditions carefully, as they affect your legal rights. Your agreement to comply with and be bound by these terms and conditions is deemed to occur upon your first use of the Website. If you do not agree to be bound by these terms and conditions, you should stop using the Website immediately.
              In these terms and conditions, User or Users means any third party that accesses the Website and is not either (i) employed by  Gamejitsu LTD  and acting in the course of their employment or (ii) engaged as a consultant or otherwise providing services to  Gamejitsu LTD  and accessing the Website in connection with the provision of such services.
              You must be at least 18 years of age to use this Website. By using the Website and agreeing to these terms and conditions, you represent and warrant that you are at least 18 years of age.
              Intellectual property and acceptable use
              <br/><br/>
              1.  All Content included on the Website, unless uploaded by Users, is the property of  Gamejitsu LTD,  our affiliates or other relevant third parties. In these terms and conditions, Content means any text, graphics, images, audio, video, software, data compilations, page layout, underlying code and software and any other form of information capable of being stored in a computer that appears on or forms part of this Website, including any such content uploaded by Users. By continuing to use the Website you acknowledge that such Content is protected by copyright, trademarks, database rights and other intellectual property rights. Nothing on this site shall be construed as granting, by implication, estoppel, or otherwise, any license or right to use any trademark, logo or service mark displayed on the site without the owner's prior written permission
              <br/><br/>
              2.  You may, for your own personal, non-commercial use only, do the following:
              <br/><br/>
              3.  You must not otherwise reproduce, modify, copy, distribute or use for commercial purposes any Content without the written permission of  Gamejitsu LTD.
              <br/><br/>
              ...
              <br/><br/>
              5.  You represent and warrant that you own or otherwise control all the rights to the Content you post; that the Content is accurate; that use of the Content you supply does not violate any provision of these terms and conditions and will not cause injury to any person; and that you will indemnify  Gamejitsu LTD  for all claims resulting from Content you supply.
              ...
              11.  This Website may contain links to other sites. Unless expressly stated, these sites are not under the control of  Gamejitsu LTD  or that of our affiliates.
              <br/><br/>
              ...
              14.  Use of the Website is also governed by our Privacy Policy and Cookies Policy, which are incorporated into these terms and conditions by this reference. To view the Privacy Policy and Cookies Policy, please click on the following: gamejitsu.gg/privacy-policy and gamejitsu.gg/cookies-policy.
              <ParagraphTitle>Availability of the Website and disclaimers</ParagraphTitle>
              15.  Any online facilities, tools, services or information that  Gamejitsu LTD  makes available through the Website (the Service) is provided "as is" and on an "as available" basis. We give no warranty that the Service will be free of defects and/or faults. To the maximum extent permitted by the law, we provide no warranties (express or implied) of fitness for a particular purpose, accuracy of information, compatibility and satisfactory quality.  Gamejitsu LTD  is under no obligation to update information on the Website.
              <br/><br/>
              16.  Whilst  Gamejitsu LTD  uses reasonable endeavours to ensure that the Website is secure and free of errors, viruses and other malware, we give no warranty or guaranty in that regard and all Users take responsibility for their own security, that of their personal details and their computers.
              <br/><br/>
              17.   Gamejitsu LTD  accepts no liability for any disruption or non-availability of the Website.
              <br/><br/>
              ...
              <br/><br/>
              21.  To the maximum extent permitted by law,  Gamejitsu LTD  accepts no liability for any of the following:
              <br/>
              ...
              29.  Gamejitsu LTD is a company incorporated in England and Wales with registered number 12096404 whose registered address is 20-22 Wenlock Road, London, N1 7GU and it  operates the Website gamejitsu.gg.
              You can contact Gamejitsu LTD by email on admin@gamejitsu.gg.
              <ParagraphTitle>Attribution</ParagraphTitle>
              30.  These terms and conditions were created using a document from Rocket Lawyer (https://www.rocketlawyer.co.uk).
              </ParagraphText>
          </Box>
        </Box>
      </TextCard>
