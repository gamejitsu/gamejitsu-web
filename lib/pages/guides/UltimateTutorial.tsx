    ...
    <Container>
      <Box px={[4]} pt={[4]}>
        ...
        <GuideParagraph>
          ...
          literally vertical learning curve, and written guides may be helpful for players who like
          ...
          <br />
          <br />
          Your first step? Download the game, get into the main menu, click on Play Dota, and start
          a bot match. I recommend easy because passive bots aren’t passive, they’re completely
          useless in helping you learn the game because passive bots ACTIVELY REFUSE TO ATTACK THE
          PLAYER.
          <br />
          <br />
          <b>F1 to select your hero</b> (you can change every hotkey in the settings menu),{" "}
          <b>
            heroes normally have 4 spells they can cast to do things, 6 item slots to buy items that
            can also do things, you get to learn or upgrade a spell every time you level up, one of
            the spells is an ultimate spell that you can only acquire at level 6.
          </b>
          <br />
          <br />
        ...
        <GuideParagraph>
          <ol>
            ...
            <li>
              ...
              play barbie doll and dress up your hero later. Dota has a far more developed cosmetics
              (“skin”) system compared to almost every other online game in the world. Have fun
              wasting money buying hats!
            </li>
          </ol>
        </GuideParagraph>
        <GuideCarousel
        ...
        <GuideParagraph>
          <ol>
            ...
            <li>
              This is the shop. You can also access the shop by clicking on the button on the bottom
              right of your screen, but you don’t really need to buy anything more now. You don’t
              have money anymore anyway after buying the recommended starting items.
            </li>
            <li>
              This is your “Ancient”. Obviously, since the game is called “Defense of the Ancients”,
              you want to defend this thing and destroy the enemy’s Ancient to win.
            </li>
            <li>
            ...
            <li>
              ...
              punish anyone who tries to cross it. You can only destroy the tier 2 tower only if the
              tier 1 tower is already destroyed. I mean, you need to know how to walk before you
              run, right?
            </li>
          </ol>
        </GuideParagraph>
        ...
        <GuideParagraph>
          <ol>
            <li>
              ...
              that. (You can of course play any hero in any lane. The middle lane is generally a 1v1
              matchup, so when you die, congratulations, you have no one else to blame.)
            </li>
          </ol>
        </GuideParagraph>
        <GuideCarousel
        ...
        <GuideParagraph>
          <ol>
            ...
            <li>
              You can also do a “deny”, which is… killing your own creeps. Imagine being in the army
              and your teammate kills you because you don’t want your teammate dying under the enemy
              hands? … Yeah that makes absolutely no sense. However, denying causes the enemy hero
              to gain reduced EXP from the creep death. It annoys the heck out of them too, look at
              that “!”, isn’t it pissing you off?
            </li>
          </ol>
        </GuideParagraph>
        <GuideCarousel
        ...
        <GuideParagraph>
          <ol>
            <li>
              ...
              people. We are the Radiant, bright and sunny kids who love nature and peace… who am I
              kidding you want to kill your opponents too.
            </li>
            <li>
              We do not want to get close to the tower during the early game simply because we are
              too weak to tank the tower damage. Towers hit like a truck, so we let our creeps tank
              the tower.
            </li>
          </ol>
        </GuideParagraph>
        ...
        <GuideParagraph>
          <ol>
            ...
            <li>
              ...
              game because you are a donkey… for now) will automatically pick up whatever items you
              bought and start delivering them to you. You’ve probably understood the important fact
              that you need to be at the base to buy items immediately. This ain’t some mobile MOBA
              game where you can purchase items anywhere on the map. It’s logical anyway.
            </li>
            <li>
        ...
        <GuideParagraph>
          <ol>
            <li>
              Remember the Soul Ring you bought? This item solves your mana problems. If you haven’t
              realised, casting spells not only has a cooldown, but mana cost too. If you don’t have
              mana, you can’t cast spells. Notably for Davion, having no mana means you can’t
              breathe fire. (No you can’t use gasoline as a replacement), stun people with your
              shield (I am pretty sure you just need your hands instead of magical power to do that,
              but welcome to Dota 2) and you can’t turn into a Dragon either. Anyways, clicking on
              the Soul Ring casts it, and gives you 150 mana for 10 seconds at the expense of 170
              HP. What a demonic item.
            </li>
            <li>
              The item goes into cooldown when you use it. What do I mean by 10 seconds? It means if
              you don’t use up the 150 mana, it disappears after 10 seconds. No you do not get your
              health back.
            </li>
            ...
            <li>
              ...
              you use up the mana, then there’s no mana to disappear! Perfect logic. This basically
              means we get a free Breathe Fire approximately every 30 seconds. Wait don’t we lose
              HP? Davion is tanky and has Dragon Blood for faster HP regen, so the item synergizes
              perfectly. Now treat your enemies to some tasty fire.
            </li>
          </ol>
        </GuideParagraph>
        <GuideCarousel
          ...
          picturesUrl={["lowq_c09_001_gank.jpg", "lowq_c09_002_gank.jpg", "lowq_c09_003_gank.jpg"]}
        />
        <GuideParagraph>
          <ol>
            <li>
              In Dota, a “gank” is basically… many people ganging up on a target to bully him. Does
              it remind you of your high school life?
            </li>
            <li>
            ...
            <li>
              ...
              preventing him from escaping while you and your bully mates whack the living daylights
              out of him
            </li>
            <li>
            ...
            <li>Congratulations, you’ve just cooked a watermelon. I hope it tastes like steak.</li>
          </ol>
        </GuideParagraph>
        <GuideCarousel
          carouselId={"ch10"}
        ...
        <GuideParagraph>
          <ol>
            <li>
              ...
              walking home because you’re such a lazy bum? Oh sweet child. Let’s use the Town Patrol
              scroll, otherwise known as Teleport scroll, TP scroll, toilet paper, whatever you want
              to call it to go home quickly.{" "}
            </li>
            <li>
              Simply click on it twice and you’ll automatically Teleport home. You can also manually
              target your base buildings. The TP Scroll teleports you to any friendly buildings.
            </li>
            <li>
            ...
            <li>
              After the spell ends, you’ll be at home! If you periodically lose track of where your
              hero is, simply click F1 a few times and your camera will be moved automatically to
              your hero.
            </li>
        ...
        <GuideParagraph>
          <ol>
            ...
            <li>
              ...
              killing you. The gold gained by the enemy is not equal to the gold you lost, so don’t
              worry. Generally, the richer you are, the more gold the killer gains when you die.
            </li>
          </ol>
        </GuideParagraph>
        <GuideCarousel
        ...
        <GuideParagraph>
          <ol>
            <li>
              ...
              animals living in the jungle with their loved families until you decide to step in and
              massacre all of them just for that little bit of gold and occasional item drops. You
              monster.
            </li>
            <li>
        ...
        <GuideParagraph>
          <ol>
            ...
            <li>
              This is the enemy mid melee barracks. Destroying it will upgrade your melee creeps for
              the middle lane.
            </li>
            <li>
              This is the enemy mid ranged barracks. Destroying it will upgrade your ranged creeps
              for the middle lane. We have more melee creeps than ranged creeps, so it is generally
              recommended to prioritize destroying the melee barracks first. Once again, the
              buildings do not respawn.
            </li>
        ...
        <GuideCarousel
          ...
          picturesUrl={["lowq_c18_001_mega.jpg", "lowq_c18_002_mega.jpg", "lowq_c18_003_mega.jpg"]}
        />
        <GuideParagraph>
          <ol>
            <li>
        ...
        <GuideParagraph>
          <ol>
            <li>
              ...
              only when I die. You can purchase items when you’re alive too. Let’s purchase a Black
              King Bar. No, you can’t eat it, it isn’t energy nor a chocolate bar.
            </li>
            <li>
              If the item appears in your bottom inventory, it means it is in the backpack. You are
              carrying the item but the item does not provide bonuses in the backpack. You need to
              drag and drop it into your primary inventory.
            </li>
        ...
        <GuideParagraph>
          <ol>
            <li>
              We have managed to surround 4 heroes! (...with just ourselves, but it doesn’t matter!)
            </li>
            <li>Let’s activate Dragon Form and get ready to 1v4 like a man.</li>
            <li>
              Click on Black King Bar to activate it. The BKB gives you magic immunity, which makes
              you nearly invincible to magic attacks and spells. You also glow yellow and grow
              bigger, which… looks cool but that’s about it.
            </li>
          </ol>
        </GuideParagraph>
        <GuideCarousel
        ...
        <GuideParagraph>
          That concludes episode 1. Episode 1 only covers the most basic gameplay enough to help you
          complete a game but doesn’t really go into the details on anything. The more you play, the
          more you learn about new stuff. This game has such a deep learning curve you’ll still find
          yourself learning new things after a few thousand hours. I have 20000 hours into the game
