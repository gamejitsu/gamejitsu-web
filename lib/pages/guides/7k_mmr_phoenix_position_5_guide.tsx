...
const Position5PhoenixGuide: AuthenticatedComponent = () => {
  return (
    <>
      <Head>
        <title>{`Gamejitsu - 7k MMR Phoenix Position 5 Guide`}</title>
      </Head>
      <Container>
        <Box px={[4]} pt={[4]}>
          <a id="start"></a>
          ...
          <GuideParagraph>
            ...
            <ul>
              <li style={{ textDecoration: "line-through" }}>
                Because scree kaw kaw haha im a bird
              </li>
              <li>
                The strength of Phoenix is its ability to push waves while not showing on the map,
                making it very easy to play the dead lane as Phoenix is very evasive and hard to
                kill.
              </li>
              ...
              <li>
                ...
                current meta where anyone can be a 5, Phoenix excels because it is great at
                teamfights later.
              </li>
              <li>
                Phoenix is also extremely good at sieging with Sunray and using Egg if they
                overcommit. The damage, the heal, the bzzzzzt sound effect demoralizing enemies to
                try to commit fully into teamfights are all its strong points.
              </li>
            </ul>
          </GuideParagraph>
          ...
          <GuideParagraph>
            <ul>
              <li>
                As a support Phoenix, sometimes you can change up your build and decide between
                maxing Sun Ray or Fire Spirits.
              </li>
              <li>
              ...
              <li>
                The deadlane essentially means the most risky lane to play in, Typically, this may
                be the lane which is the most pushed out, or the lane where the enemy heroes have
                the highest kill potential.
              </li>
              <li>
                Dead lanes are hard to push, but still keeping them pushed causes a tug-of-war
                effect, where the enemies have to commit heroes to come and defend while you can
                immediately TP back to force a 5v4 teamfight.
              </li>
              <li>
                Phoenix can push deadlanes effectively because you can throw Fire Spirits from a
                super far range, out of sight.
              </li>
              <li>
                If enemies ever try to catch you when you try to push deadlanes, just Icarus Dive
                and TP away. Take extra caution if the enemy has heroes like a Spirit Breaker
                though.
              </li>
            </ul>
          </GuideParagraph>
          ...
          <GuideParagraph>
            <ul>
              ...
              <li>
                With a 51/44/37/30 cooldown scaling on its Fire Spirits, as a support, in most
                cases, you will mostly be using your Spirits to harass/trade off cd and playing
                defensively while concentrating on stacking/pulling to get as much exp as possible
                without leeching too much from your core.
              </li>
              <li>
                In game 3 of IG vs EG in the Singapore Major, Oli's Phoenix was literally lvl 1 with
                not a single point of exp until 4 minutes because he kept getting chased and
                harassed around by Cr1t.
              </li>
              <li>
                Sometimes you have to save your Spirits just to survive (especially against a Tusk
                or Earth Spirit). Position 4/5 Phoenix playstyle is very similiar, playing to get
                levels and winning the lane is a bonus.
              </li>
              <li>
              ...
              <li>
                Also, a few simple tricks to hit your Spirits easily. Throw Spirits when the enemy
                is trying to last hit a specific creep, or deny creeps.
              </li>
              <li>
                Ideally avoid throwing two or more spirits at once unless you’re confident you can
                hit two heroes separately, because you want to keep your Spirits with you for as
                long as possible to force movements from the enemies.
              </li>
              <li>
          ...
          <GuideHeading2>
            Early Game, what should Phoenix be doing in the laning stage?
          </GuideHeading2>
          <GuideParagraph>
            <ul>
          ...
          <GuideParagraph>
            <ul>
              ...
              <li>
                In some cases, the deadlane can't be occupied even by a Phoenix but it's still a
                good idea to shove the deadlane to force rotations.
              </li>
              <li>
                Pay attention to your EXP and the game time and try to get lvl 6 before 10-12
                minutes. One dirty trick I use if the carry refuses to jungle when he could is to
                ping jungle camps and tell him “I think there’s stacks here” to trick him into
                leaving the lane while I take lane farm.
              </li>
              <li>
                ...
                laning stage is so that the carry has enough farm/levels to move out from the
                safelane to pressure the enemy safelane tower or jungle efficiently.
              </li>
              <li>
          ...
          <GuideParagraph>
            <ul>
              ...
              <li>
                ...
                the deadlane which is the most unsafe lane and shove it out while hiding in the
                trees.
              </li>
              <li>
          ...
          <GuideParagraph>
            <ul>
              <li>
                Anything goes at this point and as long as you get your egg off, the fights should
                be rather easy. Because in the late game, your cores should have disables in the
                form of Abyssal Blades or enough damage to deter the enemy from killing your egg.
              </li>
              <li>
          ...
          <GuideParagraph>
            <ul>
              <li>
                That being said, try not to aggressively Egg to start fights. The use of Egg should
                be more towards counter-intitiating or resetting fights. You want the primary effect
                of confusing the enemy on whether they should destroy your egg or run, not go in and
                tell them to “hit me, HIT ME”. You aren’t a masochist, those are Bristleback
                players.
              </li>
              <li>
                Always try to fight around compact areas with hills/highgrounds nearby. If you
                manage to get your Egg off on a cliff it’s pretty hard to lose a fight.
              </li>
            </ul>
          </GuideParagraph>
          <GuideImage
          ...
          <GuideParagraph>
            <ul>
              <li>
                ...
                position and you made the enemy overcommit to kill you. Oli really prioritizes
                having buyback unless he can get his Eul's in 1 shot.
              </li>
              <li>
                Euls - Your main job in teamfights is to get your egg off, and you can't do it if
                you are dead. Eul's helps you to survive and kite in fights as well as give you a
                disable.
              </li>
              <li>
              ...
              <li>
                Refresher - What's better than 1 egg? Pay attention to your mana and carry some
                spare mangos if you decide to rush Refresher. If the enemy has no kill threat on you
                at all you can just rush a refresher to guarantee a teamfight win.
              </li>
              <li>
                Halberd - If you don't feel you need a dispel in the form of Euls, you can tank
                yourself up instead to make the enemy take longer to kill you. Halberd is also
                overall a great item against the meta carries in this patch (Troll, Monkey King,
                Slark, etc).
              </li>
              <li>
              ...
              <li>
                Aghanims – It's an okay item but only get it if the enemy has no egg hitters or if
                you are absolutely confident in your Egg positions.
              </li>
              <li>
                Urn of Shadows – As a 5, you won’t actually be making many aggressive plays to get
                urn charges and instead you will mostly be breaking smokes and covering your cores.
                I highly recommend against getting Urn as a 5 unless nobody else is getting it.
              </li>
            </ul>
          </GuideParagraph>
        </Box>
